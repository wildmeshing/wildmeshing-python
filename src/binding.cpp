...
PYBIND11_MODULE(wildmeshing, m)
{
    ...
    m.def("triangulate", [](const std::string &input, const std::string &feature_input, const std::string &output, double stop_quality, int max_its, int stage, double epsilon, double feature_epsilon, double target_edge_len, double edge_length_r, double flat_feature_angle, bool cut_outside, bool skip_eps, const std::string &hole_file, bool mute_log) {
         init_globals();
        ...
        .def("tetrahedralize", [](const std::string &input, const std::string &output, double stop_quality, int max_its, int stage, int stop_p, double epsilon, double edge_length_r, bool mute_log, bool skip_simplify) {
